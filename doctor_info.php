...
<script>
	...
	function cargarEspecialidades(){
		...
		var options = ["Alergología", "Anatomía Patológica", "Anestesiología", "Angiología", "Antropología Médica"];
	...
	<section id="buscar" class="section section-padded">
		<div class="container">
			<div class="row text-center title">
				...
				<h4 class="light muted">Busca a los mejores especialistas médicos de tu localidad.</h4>
